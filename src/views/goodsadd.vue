            ...
            <el-tabs v-model="active" tab-position="left" @tab-click="tabChange()">
                <el-tab-pane name="1" label="基本信息">
                    ...
                    <el-form-item label="商品分类">
                        <!-- 级联选择器 -->
                        <br>
                        <el-cascader expand-trigger="hover" clearable :props="defaultProp" :options="catlist" v-model="selectedOptions" @change="handleChange">
                        </el-cascader>
                    </el-form-item>

                </el-tab-pane>
                <el-tab-pane name="2" label="商品参数">
                    <el-form-item :label="item.attr_name" v-for="item in dyParams" :key="item.attr_id">
                        <br>
                ...
                headers: {
                    ...
                    <el-upload :headers="headers" multiple action="http://localhost:8888/api/private/v1/upload" :on-preview="handlePreview" :on-remove="handleRemove"
